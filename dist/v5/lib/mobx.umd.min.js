!(function(e, t) {
                            ...
                            ;(t.lowestObserverState = e.IDerivationState.STALE),
                                t.observers.forEach(function(n) {
                                    n.dependenciesState === e.IDerivationState.UP_TO_DATE &&
                                        (n.isTracing !== X.NONE && ke(n, t), n.onBecomeStale()),
    ...
    function x(e, t, n) {
        ...
        var r = new _(e)
        return t !== p && Qe(r, t), n !== p && Ze(r, n), r
    }
    var D = {
        ...
        j = Symbol("mobx did run lazy initializers"),
    ...
    function I(e) {
        ...
        if (!0 !== e[j]) {
            ...
            if (o) {
                y(e, j, !0)
                var a = i(Object.getOwnPropertySymbols(o), Object.keys(o))
                try {
    ...
    function P(e, t) {
        return function() {
            var r,
                o,
                i = function(o, i, a, s) {
                    if (!0 === s) return t(o, i, a, o, r), null
            ...
            return ((2 === (o = arguments).length || 3 === o.length) &&
                ("string" == typeof o[1] || "symbol" == typeof o[1])) ||
                (4 === o.length && !0 === o[3])
                ? ((r = s), i.apply(null, arguments))
    ...
    var M = k(N),
        U = k(function(e, t, n) {
            return null == e
                ...
                ? e
                : Array.isArray(e)
                ? H.array(e, { name: n, deep: !1 })
                : v(e)
                ? H.object(e, void 0, { name: n, deep: !1 })
                : g(e)
                ? H.map(e, { name: n, deep: !1 })
                : m(e)
                ? H.set(e, { name: n, deep: !1 })
                : l(!1)
        }),
        G = k(V),
        q = k(function(e, t, n) {
    ...
    var z = {
            box: function(e, t) {
                ...
                var n = L(t)
                return new me(e, K(n), n.name, !0, n.equals)
            },
            array: function(e, t) {
                ...
                return (function(e, t, n, r) {
                    ...
                    var i, a, s
                    var u = new Proxy(o.values, Tt)
                    if (((o.proxy = u), e && e.length)) {
                        var l = be(!0)
                        o.spliceWithArray(0, 0, e), ge(l)
                    }
                    return u
                })(e, K(n), n.name)
            },
    ...
    var J,
        X,
        Y = P(!1, function(e, t, r, o, i) {
            var a = r.get,
                s = r.set,
                u = i[0] || {}
            Ht(e).addComputedProp(e, t, n({ get: a, set: s, context: e }, u))
        }),
        F = Y({ equals: D.structural }),
        $ = function(e, t, n) {
    ...
    ;($.struct = F),
        ((J = e.IDerivationState || (e.IDerivationState = {}))[(J.NOT_TRACKING = -1)] =
            "NOT_TRACKING"),
    ...
    function ee(t) {
        switch (t.dependenciesState) {
            ...
            case e.IDerivationState.POSSIBLY_STALE:
                for (var n = se(!0), r = ie(), o = t.observing, i = o.length, a = 0; a < i; a++) {
                    var s = o[a]
                    if (Se(s)) {
                        if (Ce.disableErrorBoundaries) s.get()
                        else
                            try {
                                s.get()
                            } catch (e) {
                ...
                return ce(t), ae(r), ue(n), !1
        }
    }
    function te(e) {
        var t = e.observers.size > 0
        Ce.computationDepth > 0 && t && l(!1),
            Ce.allowStateChanges || (!t && "strict" !== Ce.enforceActions) || l(!1)
    }
    function ne(t, n, r) {
        var o = se(!0)
        ce(t),
            ...
            (t.runId = ++Ce.runId)
        var i,
            a = Ce.trackingDerivation
        if (((Ce.trackingDerivation = t), !0 === Ce.disableErrorBoundaries)) i = n.call(r)
        else
            try {
                i = n.call(r)
            } catch (e) {
        ...
        return (
            ...
            (function(t) {
                ...
                for (; a--; ) {
                    var u = n[a]
                    0 === u.diffValue && Te(u, t), (u.diffValue = 0)
                }
                for (; i--; ) {
                    var u = r[i]
                    1 === u.diffValue && ((u.diffValue = 0), Re(u, t))
                }
                o !== e.IDerivationState.UP_TO_DATE &&
    ...
    var le = 0,
        fe = 1,
        he = Object.getOwnPropertyDescriptor(function() {}, "name")
    he && he.configurable
    function pe(e, t, n) {
        var r = function() {
            return de(e, t, n || this, arguments)
        }
    ...
    function ye(e) {
        le !== e.actionId && l("invalid action stack. did you forget to finish an action?"),
            (le = e.parentActionId),
            ...
            return (
                ...
                (n.prototype.setNewValue = function(e) {
                    ...
                    ;(this.value = e),
                        this.reportChanged(),
                        jt(this) &&
                            Rt(this, { type: "update", object: this, newValue: e, oldValue: t })
                }),
        ...
        Oe = (function() {
            function t(t) {
                ;(this.dependenciesState = e.IDerivationState.NOT_TRACKING),
                    ...
                    f(t.get, "missing option for computed: get"),
                    (this.derivation = t.get),
                    (this.name = t.name || "ComputedValue@" + c()),
                    t.set && (this.setter = pe(this.name + "-setter", t.set)),
                    (this.equals =
                        t.equals || (t.compareStructural || t.struct ? D.structural : D.default)),
            ...
            return (
                ...
                (t.prototype.get = function() {
                    this.isComputing &&
                        l("Cycle detected in computation " + this.name + ": " + this.derivation),
                ...
                (t.prototype.suspend = function() {
                    this.keepAlive || (re(this), (this.value = void 0))
                }),
                (t.prototype.observe = function(e, t) {
                    ...
                    return Ye(function() {
                        ...
                        if (!r || t) {
                            var a = ie()
                            e({ type: "update", object: n, newValue: i, oldValue: o }), ae(a)
                        }
                        ;(r = !1), (o = i)
                    })
                }),
    ...
    var De = !0,
        ...
        Ce = (function() {
            ...
            return (
                ...
                e.__mobxGlobals && e.__mobxGlobals.version !== new _e().version && (De = !1),
                De
                    ? e.__mobxGlobals
                        ? ((e.__mobxInstanceCount += 1),
                          e.__mobxGlobals.UNCHANGED || (e.__mobxGlobals.UNCHANGED = {}),
                          e.__mobxGlobals)
                        : ((e.__mobxInstanceCount = 1), (e.__mobxGlobals = new _e()))
                    : (setTimeout(function() {
                          je ||
                              l(
    ...
    var Be = (function() {
        ...
        return (
            ...
            (t.prototype.schedule = function() {
                this._isScheduled ||
                    ((this._isScheduled = !0), Ce.pendingReactions.push(this), Ue())
            }),
            ...
            (t.prototype.dispose = function() {
                this.isDisposed ||
                    ((this.isDisposed = !0), this._isRunning || (Pe(), re(this), Ne()))
            }),
    ...
    function We(e) {
        return function(t, n, r) {
            if (r) {
                if (r.value)
                    return { value: pe(e, r.value), enumerable: !1, configurable: !0, writable: !0 }
                var o = r.initializer
                return {
                    enumerable: !1,
                    configurable: !0,
    ...
    var Je = function(e, t, n, r) {
        return 1 === arguments.length && "function" == typeof e
            ...
            : void y(e, t, pe(e.name || t, n.value, this))
    }
    function Xe(e, t, n) {
        y(e, t, pe(t, n.bind(e)))
    }
    ...
    Je.bound = function(e, t, n, r) {
        return !0 === r
            ...
            ? {
                  ...
                  enumerable: !1,
                  get: function() {
                      return Xe(this, t, n.value || n.initializer.call(this)), this[t]
                  },
                  set: He
              }
            : {
    ...
    function et(e, t, n, r) {
        var o = "function" == typeof r ? $t(t, n) : $t(t),
    ...
    function tt(e, t, n, r) {
        var o = nt((r = L(r)))
        return I(e), Ht(e, r.name, o.enhancer), t && rt(e, t, n, o), e
    }
    function nt(e) {
    ...
    function rt(e, t, n, o) {
        ...
        try {
            var s = w(t)
            try {
                for (var u = r(s), c = u.next(); !c.done; c = u.next()) {
                    var l = c.value,
                        f = Object.getOwnPropertyDescriptor(t, l)
                    0
                    var h = n && l in n ? n[l] : f.get ? Y : o
                    0
                    var p = h(e, l, f, !0)
    ...
    function ft(e) {
        return arguments.length > 1 ? l(!1) : lt(e)
    }
    function ht(e, t) {
        return (
            null != e &&
            (void 0 !== t
                ? !!Ft(e) && e[A].values.has(t)
                : Ft(e) || !!e[A] || E(e) || qe(e) || Se(e))
        )
    }
    function pt(e) {
        return 1 !== arguments.length && l(!1), ht(e)
    }
    function dt(e) {
        return Ft(e)
            ? e[A].getKeys()
    ...
    var _t = {
        has: function(e, t) {
            if (t === A || "constructor" === t || t === j) return !0
            var n = St(e)
            return At(t) ? n.has(t) : t in e
        },
        get: function(e, t) {
            if (t === A || "constructor" === t || t === j) return e[t]
            var n = St(e),
                r = n.values.get(t)
            if (r instanceof _) {
                var o = r.get()
        ...
        set: function(e, t, n) {
            return !!At(t) && (vt(e, t, n), !0)
        },
        deleteProperty: function(e, t) {
            return !!At(t) && (St(e).remove(t), !0)
        },
        ownKeys: function(e) {
    ...
    function Dt(e, t) {
        ...
        try {
            for (
                var r = i(e.interceptors || []), o = 0, a = r.length;
                o < a &&
                (f(
                    !(t = r[o](t)) || t.type,
        ...
        get: function(e, t) {
            return t === A
                ...
                ? Pt.hasOwnProperty(t)
                    ? Pt[t]
                    : e[t]
                : Pt.get.call(e, parseInt(t))
        },
        set: function(e, t, n) {
            return (
                "length" === t && e[A].setArrayLength(n),
                "number" == typeof t && Pt.set.call(e, t, n),
                "symbol" == typeof t || isNaN(t) ? (e[t] = n) : Pt.set.call(e, parseInt(t), n),
                !0
            )
        },
        preventExtensions: function(e) {
                    ...
                    var r = !this.owned && !1,
                        ...
                        i =
                            o || r
                                ...
                                : null
                    this.atom.reportChanged(), o && Rt(this, i)
                }),
        ...
        Pt = {
            ...
            set: function(e, t) {
                ...
                if (e < r.length) {
                    ...
                    var o = r[e]
                    if (Et(n)) {
                        var i = Dt(n, { type: "update", object: n.proxy, index: e, newValue: t })
                        if (!i) return
                        t = i.newValue
                    }
    ...
    var Nt,
        Vt = b("ObservableArrayAdministration", It)
    function kt(e) {
        return d(e) && Vt(e[A])
    }
    var Bt,
        ...
        Mt = (function() {
            function e(e, t, n) {
                if (
                    ...
                    (this.name = n),
                    (this[Nt] = Lt),
                    (this._keysAtom = x(this.name + ".keys()")),
            ...
            return (
                ...
                (e.prototype.has = function(e) {
                    ...
                    if (!n) {
                        var r = (n = new me(this._has(e), V, this.name + "." + O(e) + "?", !1))
                ...
                (e.prototype.delete = function(e) {
                    var t = this
                    if (Et(this) && !(r = Dt(this, { type: "delete", object: this, name: e })))
                        return !1
                    if (this._has(e)) {
                        var n = jt(this),
                            r = n
                ...
                (e.prototype._addValue = function(e, t) {
                    ...
                    te(this._keysAtom),
                        wt(function() {
                            var r = new me(t, n.enhancer, n.name + "." + O(e), !1)
                            n._data.set(e, r),
                                (t = r.value),
                    ...
                    var r = jt(this)
                    r && Rt(this, r ? { type: "add", object: this, name: e, newValue: t } : null)
                }),
                ...
                (e.prototype[((Nt = A), Symbol.iterator)] = function() {
                    return this.entries()
                }),
                (e.prototype.forEach = function(e, t) {
                    var n, i
                    try {
                        for (var a = r(this), s = a.next(); !s.done; s = a.next()) {
                            var u = o(s.value, 2),
                                c = u[0],
                                l = u[1]
                            e.call(t, l, c, this)
                ...
                (e.prototype.toPOJO = function() {
                    var e,
                        ...
                        n = {}
                    try {
                        for (var i = r(this), a = i.next(); !a.done; a = i.next()) {
                            var s = o(a.value, 2),
                                u = s[0],
                                c = s[1]
                            n["symbol" == typeof u ? u : O(u)] = c
                        }
                    } catch (t) {
                        e = { error: t }
                    } finally {
        ...
        qt = (function() {
            ...
            return (
                ...
                (e.prototype.clear = function() {
                    ...
                    wt(function() {
                        oe(function() {
                            ...
                            try {
                                for (
                                    var o = r(e._data.values()), i = o.next();
                                    !i.done;
                                    i = o.next()
                                ) {
                                    var a = i.value
                ...
                (e.prototype.add = function(e) {
                    var t = this
                    if (
                        (te(this._atom), Et(this)) &&
                        !(r = Dt(this, { type: "add", object: this, newValue: e }))
                    )
                        return this
                    if (!this.has(e)) {
                        wt(function() {
                ...
                (e.prototype.delete = function(e) {
                    var t = this
                    if (Et(this) && !(r = Dt(this, { type: "delete", object: this, oldValue: e })))
                        return !1
                    if (this.has(e)) {
                        var n = jt(this),
                ...
                (e.prototype[((Bt = A), Symbol.iterator)] = function() {
                    return this.values()
                }),
                e
            )
        })(),
        Kt = b("ObservableSet", qt),
        zt = (function() {
            function e(e, t, n, r) {
                void 0 === t && (t = new Map()),
                    (this.target = e),
            ...
            return (
                ...
                (e.prototype.has = function(e) {
                    ...
                    return (
                        (n = new me(r, V, this.name + "." + O(e) + "?", !1)), t.set(e, n), n.get()
                    )
                }),
                (e.prototype.addObservableProp = function(e, t, n) {
                    ...
                    var i = new me(t, n, this.name + "." + O(e), !1)
                    this.values.set(e, i),
                        (t = i.value),
                ...
                (e.prototype.notifyPropertyAddition = function(e, t) {
                    var n = jt(this),
                        r = n
                            ...
                            : null
                    if ((n && Rt(this, r), this.pendingKeys)) {
                ...
                (e.prototype.getKeys = function() {
                    ...
                    var n = []
                    try {
                        for (var i = r(this.values), a = i.next(); !a.done; a = i.next()) {
                            var s = o(a.value, 2),
                                u = s[0]
                            s[1] instanceof me && n.push(u)
                        }
                    } catch (t) {
                        e = { error: t }
                    } finally {
    ...
    var Yt = b("ObservableObjectAdministration", zt)
    function Ft(e) {
        return !!d(e) && (I(e), Yt(e[A]))
    }
    function $t(e, t) {
        if ("object" == typeof e && null !== e) {
            if (kt(e)) return void 0 !== t && l(!1), e[A].atom
            if (Kt(e)) return e[A]
            if (Ut(e)) {
                var n = e
                return void 0 === t
                    ? n._keysAtom
                    : ((r = n._data.get(t) || n._hasMap.get(t)) || l(!1), r)
            }
            var r
            if ((I(e), t && !e[A] && e[t], Ft(e)))
                return t ? ((r = e[A].values.get(t)) || l(!1), r) : l(!1)
            if (E(e) || Se(e) || qe(e)) return e
        } else if ("function" == typeof e && qe(e[A])) return e[A]
        return l(!1)
    }
    function Qt(e, t) {
        return (
            ...
            void 0 !== t
                ...
                : Ut(e) || Kt(e)
                ? e
                : (I(e), e[A] ? e[A] : void l(!1))
        )
    }
    function Zt(e, t) {
        return (void 0 !== t ? $t(e, t) : Ft(e) || Ut(e) || Kt(e) ? Qt(e) : $t(e)).name
    }
        ...
        return (
            ...
            (function e(t, n, r, o, i) {
                ...
                if (u) {
                    ...
                    for (; f--; )
                        if (((p = h[f]), !rn(n, p) || !e(t[p], n[p], r - 1, o, i))) return !1
                }
                o.pop()
                i.pop()
                return !0
    ...
    "object" == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ &&
        ...
        (e._allowStateReadsEnd = ue),
        (e._allowStateReadsStart = se),
        (e._endAction = ye),
        (e._getAdministration = Qt),
        (e._getGlobalState = function() {
            return Ce
        }),
        (e._interceptReads = function(e, t, n) {
            var r
            if (Ut(e) || kt(e) || we(e)) r = Qt(e)
            else {
                if (!Ft(e)) return l(!1)
        ...
        (e._resetGlobalState = function() {
            var e = new _e()
            for (var t in e) -1 === Ae.indexOf(t) && (Ce[t] = e[t])
        ...
        (e.configure = function(e) {
            ...
            if (
                (!0 === e.isolateGlobalState &&
                    ...
                    (je = !0),
                    De &&
                        (0 == --xe().__mobxInstanceCount && (xe().__mobxGlobals = void 0),
                        (Ce = new _e()))),
                void 0 !== t)
            ) {
                var u = void 0
                ...
                ;(Ce.enforceActions = u), (Ce.allowStateChanges = !0 !== u && "strict" !== u)
            }
            void 0 !== n && (Ce.computedRequiresReaction = !!n),
                void 0 !== a && (Ce.reactionRequiresObservable = !!a),
                void 0 !== s &&
                    ((Ce.observableRequiresReaction = !!s),
                    (Ce.allowStateReads = !Ce.observableRequiresReaction)),
                void 0 !== r && (Ce.computedConfigurable = !!r),
                void 0 !== o &&
                    (!0 === o &&
                        console.warn(
                            "WARNING: Debug feature only. MobX will NOT recover from errors when `disableErrorBoundaries` is enabled."
                        ),
                    (Ce.disableErrorBoundaries = !!o)),
                i && Ke(i)
        }),
        (e.createAtom = x),
        ...
        (e.extendObservable = tt),
        (e.flow = function(e) {
            1 !== arguments.length && l("Flow expects 1 argument and cannot be used as decorator")
            var t = e.name || "<unnamed flow>"
            return function() {
                var n,
                    r = arguments,
                    o = ++st,
                    i = Je(t + " - runid: " + o + " - init", e).apply(this, r),
                    a = void 0,
                    s = new Promise(function(e, r) {
                        ...
                        function u(e) {
                            ...
                            a = void 0
                            try {
                                n = Je(t + " - runid: " + o + " - yield " + s++, i.next).call(i, e)
                            } catch (e) {
                                return r(e)
                            }
                            l(n)
                        ...
                        function c(e) {
                            ...
                            a = void 0
                            try {
                                n = Je(t + " - runid: " + o + " - yield " + s++, i.throw).call(i, e)
                            } catch (e) {
                                return r(e)
                            }
                            l(n)
                ...
                return (
                    (s.cancel = Je(t + " - runid: " + o + " - cancel", function() {
                        try {
                            a && ct(a)
                            var e = i.return(void 0),
                                t = Promise.resolve(e.value)
                            t.then(p, p), ct(t), n(new ut())
                        } catch (e) {
                            n(e)
                        }
                    })),
        ...
        (e.get = function(e, t) {
            if (yt(e, t)) return Ft(e) ? e[t] : Ut(e) ? e.get(t) : kt(e) ? e[t] : l(!1)
        }),
        (e.getAtom = $t),
        (e.getDebugName = Zt),
        (e.getDependencyTree = ot),
        ...
        (e.isArrayLike = function(e) {
            return Array.isArray(e) || kt(e)
        }),
        (e.isBoxedObservable = we),
        (e.isComputed = ft),
        ...
        (e.isObservable = pt),
        (e.isObservableArray = kt),
        (e.isObservableMap = Ut),
        (e.isObservableObject = Ft),
        (e.isObservableProp = function(e, t) {
            return "string" != typeof t ? l(!1) : ht(e, t)
        }),
        (e.isObservableSet = Kt),
        (e.keys = dt),
        (e.observable = H),
        ...
        (e.onBecomeObserved = Qe),
        (e.onBecomeUnobserved = Ze),
        ...
        (e.reaction = function(e, t, n) {
            ...
            var r,
                ...
                h = !0,
                p = !1,
                d = n.compareStructural ? D.structural : n.equals || D.default,
                v = new Be(
                    a,
                    function() {
                        h || l ? y() : p || ((p = !0), f(y))
        ...
        (e.remove = function(e, t) {
            if (Ft(e)) e[A].remove(t)
            else if (Ut(e)) e.delete(t)
        ...
        (e.runInAction = function(e, t) {
            return (
                "string" == typeof e || e.name, de(0, "function" == typeof e ? e : t, this, void 0)
            )
        }),
        (e.set = vt),
        (e.spy = ze),
        (e.toJS = function(e, t) {
            ...
            return (
                ...
                (function e(t, n, r) {
                    if (!n.recurseEverything && !pt(t)) return t
                    if ("object" != typeof t) return t
                    if (null === t) return null
                    if (t instanceof Date) return t
                    if (we(t)) return e(t.get(), n, r)
                    if ((pt(t) && dt(t), !0 === n.detectCycles && null !== t && r.has(t)))
                        return r.get(t)
                    if (kt(t) || Array.isArray(t)) {
                        var o = gt(r, t, [], n),
                            i = t.map(function(t) {
                                return e(t, n, r)
                            })
                    ...
                    if (Kt(t) || Object.getPrototypeOf(t) === Set.prototype) {
                    ...
                    if (Ut(t) || Object.getPrototypeOf(t) === Map.prototype) {
                        if (!1 === n.exportMapsAsObjects) {
