...
function addHiddenFinalProp(e, t, r) {
    Object.defineProperty(e, t, { enumerable: !1, writable: !1, configurable: !0, value: r })
}
...
function createAtom(e, t, r) {
    ...
    var n = new Atom(e)
    return t !== noop && onBecomeObserved(n, t), r !== noop && onBecomeUnobserved(n, r), n
}
...
var comparer = {
    ...
    mobxDidRunLazyInitializersSymbol = Symbol("mobx did run lazy initializers"),
...
function initializeInstance(e) {
    ...
    if (!0 !== e[mobxDidRunLazyInitializersSymbol]) {
        ...
        if (n) {
            ...
            var o = __spread(Object.getOwnPropertySymbols(n), Object.keys(n))
            try {
                for (var a = __values(o), i = a.next(); !i.done; i = a.next()) {
                    var s = n[i.value]
                    s.propertyCreator(
                        e,
                        s.prop,
...
function shallowEnhancer(e, t, r) {
    return null == e
        ? e
        : isObservableObject(e) || isObservableArray(e) || isObservableMap(e) || isObservableSet(e)
        ? e
        : Array.isArray(e)
...
function createDecoratorForEnhancer(e) {
    ...
    var t = createPropDecorator(!0, function(t, r, n, o, a) {
            var i = n ? (n.initializer ? n.initializer.call(t) : n.value) : void 0
            asObservableObject(t).addObservableProp(r, i, e)
        }),
...
var observableFactories = {
        ...
        object: function(e, t, r) {
            ...
            var o = getDefaultDecoratorFromObjectOptions(n),
                a = createDynamicObservableObject(extendObservable({}, void 0, void 0, n))
            return extendObservableObjectWithProperties(a, e, t, o), a
        },
        ref: refDecorator,
...
var TraceMode,
    computedDecorator = createPropDecorator(!1, function(e, t, r, n, o) {
        var a = r.get,
            i = r.set,
            s = o[0] || {}
        asObservableObject(e).addComputedProp(e, t, __assign({ get: a, set: i, context: e }, s))
    }),
                ...
                if (isComputedValue(i)) {
                    if (globalState.disableErrorBoundaries) i.get()
                        ...
                        try {
                            ...
                            return untrackedEnd(r), allowStateReadsEnd(t), !0
                        }
                    if (e.dependenciesState === exports.IDerivationState.STALE)
                        return untrackedEnd(r), allowStateReadsEnd(t), !0
                }
            }
            return changeDependenciesStateTo0(e), untrackedEnd(r), allowStateReadsEnd(t), !1
    }
}
...
function checkIfStateModificationsAreAllowed(e) {
    ...
    globalState.computationDepth > 0 && t && fail(!1),
        globalState.allowStateChanges || (!t && "strict" !== globalState.enforceActions) || fail(!1)
}
function trackDerivedFunction(e, t, r) {
    ...
    if (((globalState.trackingDerivation = e), !0 === globalState.disableErrorBoundaries))
        o = t.call(r)
    else
        try {
            o = t.call(r)
        } catch (e) {
            o = new CaughtException(e)
        }
    return (globalState.trackingDerivation = a), bindDependencies(e), allowStateReadsEnd(n), o
}
function bindDependencies(e) {
    for (
        ...
        0 === (s = r[i]).diffValue && ((s.diffValue = 1), o !== i && (r[o] = s), o++),
...
var currentActionId = 0,
    nextActionId = 1,
    functionNameDescriptor = Object.getOwnPropertyDescriptor(function() {}, "name"),
    isFunctionNameConfigurable = functionNameDescriptor && functionNameDescriptor.configurable
...
function _startAction(e, t, r) {
    ...
    return (currentActionId = a.actionId), a
}
    ...
    ComputedValue = (function() {
        function e(e) {
            ;(this.dependenciesState = exports.IDerivationState.NOT_TRACKING),
                ...
                (this.equals =
                    e.equals ||
                    (e.compareStructural || e.struct ? comparer.structural : comparer.default)),
        ...
        return (
            ...
            (e.prototype.get = function() {
                this.isComputing &&
                    ...
                    0 !== globalState.inBatch || 0 !== this.observers.size || this.keepAlive
                        ? (reportObserved(this),
                          shouldCompute(this) &&
            ...
            (e.prototype.observe = function(e, t) {
                ...
                return autorun(function() {
                    ...
                    if (!n || t) {
                        ...
                        e({ type: "update", object: r, newValue: a, oldValue: o }), untrackedEnd(i)
                    }
                    ;(n = !1), (o = a)
                })
            }),
...
function removeObserver(e, t) {
    e.observers.delete(t), 0 === e.observers.size && queueForUnobservation(e)
}
...
function reportObserved(e) {
    ...
    return null !== t
        ? (t.runId !== e.lastAccessedBy &&
          ...
          !0)
        : (0 === e.observers.size && globalState.inBatch > 0 && queueForUnobservation(e), !1)
}
    ...
    e.lowestObserverState !== exports.IDerivationState.STALE &&
        ...
        e.observers.forEach(function(t) {
            t.dependenciesState === exports.IDerivationState.UP_TO_DATE &&
                (t.isTracing !== TraceMode.NONE && logTraceInfo(t, e), t.onBecomeStale()),
...
var Reaction = (function() {
    ...
    return (
        ...
        (e.prototype.schedule = function() {
            this._isScheduled ||
                ((this._isScheduled = !0), globalState.pendingReactions.push(this), runReactions())
        }),
        ...
        (e.prototype.runReaction = function() {
            if (!this.isDisposed) {
                if ((startBatch(), (this._isScheduled = !1), shouldCompute(this))) {
                    ...
                    try {
                        this.onInvalidate(), this._isTrackPending && isSpyEnabled()
                    } catch (e) {
        ...
        (e.prototype.track = function(e) {
            if (!this.isDisposed) {
                startBatch(), (this._isRunning = !0)
                var t = trackDerivedFunction(this, e, void 0)
                ;(this._isRunning = !1),
                    (this._isTrackPending = !1),
                    this.isDisposed && clearObserving(this),
                    isCaughtException(t) && this.reportExceptionInDerivation(t.cause),
                    endBatch()
            }
        }),
...
var action = function(e, t, r, n) {
    return 1 === arguments.length && "function" == typeof e
        ...
        : void addHiddenProp(e, t, createAction(e.name || t, r.value, this))
}
...
function interceptHook(e, t, r, n) {
    var o = "function" == typeof n ? getAtom(t, r) : getAtom(t),
        a = "function" == typeof n ? n : r,
        i = e + "Listeners"
    return (
...
function extendObservable(e, t, r, n) {
    var o = getDefaultDecoratorFromObjectOptions((n = asCreateObservableOptions(n)))
    return (
        initializeInstance(e),
        asObservableObject(e, n.name, o.enhancer),
        t && extendObservableObjectWithProperties(e, t, r, o),
        e
    )
}
...
function extendObservableObjectWithProperties(e, t, r, n) {
    ...
    startBatch()
    try {
        var i = getPlainObjectKeys(t)
        try {
            for (var s = __values(i), c = s.next(); !c.done; c = s.next()) {
                var l = c.value,
                    u = Object.getOwnPropertyDescriptor(t, l)
                0
                var p = r && l in r ? r[l] : u.get ? computedDecorator : n
                0
                var d = p(e, l, u, !0)
                d && Object.defineProperty(e, l, d)
            }
        } catch (e) {
            o = { error: e }
        } finally {
...
function nodeToObserverTree(e) {
    var t = { name: e.name }
    return hasObservers(e) && (t.observers = Array.from(getObservers(e)).map(nodeToObserverTree)), t
}
var generatorId = 0
            ...
            s = new Promise(function(e, n) {
                ...
                function u(t) {
                    if (!t || "function" != typeof t.then)
                        return t.done ? e(t.value) : (i = Promise.resolve(t.value)).then(c, l)
                    t.then(u, n)
                }
                ;(r = n), c(void 0)
            })
        return (
            (s.cancel = action(t + " - runid: " + o + " - cancel", function() {
                try {
                    ...
                    t.then(noop, noop), cancelPromise(t), r(new FlowCancellationError())
                } catch (e) {
                    r(e)
                }
            })),
...
function interceptReads(e, t, r) {
    var n
    if (isObservableMap(e) || isObservableArray(e) || isObservableValue(e)) n = getAdministration(e)
    else {
...
function _isObservable(e, t) {
    return (
        null != e &&
        (void 0 !== t
            ? !!isObservableObject(e) && e[$mobx].values.has(t)
...
var defaultOptions = { detectCycles: !0, exportMapsAsObjects: !0, recurseEverything: !1 }
...
function toJSHelper(e, t, r) {
    ...
    if ((isObservable(e) && keys(e), !0 === t.detectCycles && null !== e && r.has(e)))
        return r.get(e)
...
function whenPromise(e, t) {
    var r,
        n = new Promise(function(n, o) {
            var a = _when(e, n, __assign(__assign({}, t), { onError: o }))
            r = function() {
                a(), o("WHEN_CANCELLED")
            }
        })
...
var objectProxyTraps = {
    ...
    get: function(e, t) {
        if (t === $mobx || "constructor" === t || t === mobxDidRunLazyInitializersSymbol)
            return e[t]
        var r = getAdm(e),
            n = r.values.get(t)
        ...
        return isPropertyKey(t) && r.has(t), e[t]
    },
    set: function(e, t, r) {
        return !!isPropertyKey(t) && (set(e, t, r), !0)
    },
    deleteProperty: function(e, t) {
        return !!isPropertyKey(t) && (getAdm(e).remove(t), !0)
    },
    ownKeys: function(e) {
        return getAdm(e).keysAtom.reportObserved(), Reflect.ownKeys(e)
    },
    preventExtensions: function(e) {
        return fail("Dynamic observable objects cannot be frozen"), !1
    }
}
function createDynamicObservableObject(e) {
    var t = new Proxy(e, objectProxyTraps)
    return (e[$mobx].proxy = t), t
}
...
function interceptChange(e, t) {
    ...
    try {
        for (
            var n = __spread(e.interceptors || []), o = 0, a = n.length;
            o < a &&
            (invariant(
                !(t = n[o](t)) || t.type,
    ...
    arrayTraps = {
        get: function(e, t) {
            return t === $mobx
                ? e[$mobx]
                : "length" === t
                ? e[$mobx].getArrayLength()
                : "number" == typeof t
                ? arrayExtensions.get.call(e, t)
                : "string" != typeof t || isNaN(t)
                ? arrayExtensions.hasOwnProperty(t)
                    ? arrayExtensions[t]
                    : e[t]
                : arrayExtensions.get.call(e, parseInt(t))
        },
        set: function(e, t, r) {
            return (
        ...
        preventExtensions: function(e) {
            return fail("Observable arrays cannot be frozen"), !1
        }
    }
function createObservableArray(e, t, r, n) {
    void 0 === r && (r = "ObservableArray@" + getNextId()), void 0 === n && (n = !1)
    var o = new ObservableArrayAdministration(r, t, n)
    addHiddenFinalProp(o.values, $mobx, o)
    var a = new Proxy(o.values, arrayTraps)
    if (((o.proxy = a), e && e.length)) {
        var i = allowStateChangesStart(!0)
        o.spliceWithArray(0, 0, e), allowStateChangesEnd(i)
    }
    return a
}
var ObservableArrayAdministration = (function() {
        ...
        return (
            ...
            (e.prototype.spliceWithArray = function(e, t, r) {
                ...
                var i = this.spliceItemsIntoValues(e, t, r)
                return (
                ...
                var n = !this.owned && isSpyEnabled(),
                    ...
                    a =
                        o || n
                            ...
                            : null
                this.atom.reportChanged(), o && notifyListeners(this, a)
            }),
    ...
    ObservableMap = (function() {
        ...
        return (
            ...
            (e.prototype.delete = function(e) {
                ...
                if (
                    hasInterceptors(this) &&
                    !(o = interceptChange(this, { type: "delete", object: this, name: e }))
                )
                    return !1
                if (this._has(e)) {
                    var r = isSpyEnabled(),
                    ...
                    var n = isSpyEnabled(),
                        ...
                        a =
                            o || n
                                ...
                                : null
                    0, r.setNewValue(t), o && notifyListeners(this, a)
                }
            }),
            ...
            (e.prototype.values = function() {
                ...
                return makeIterable({
                    next: function() {
                        return t < r.length ? { value: e.get(r[t++]), done: !1 } : { done: !0 }
                    }
                })
            }),
            ...
            (e.prototype.forEach = function(e, t) {
                var r, n
                try {
                    for (var o = __values(this), a = o.next(); !a.done; a = o.next()) {
                        var i = __read(a.value, 2),
                            s = i[0],
                            c = i[1]
                        e.call(t, c, s, this)
                    }
            ...
            (e.prototype.clear = function() {
                ...
                transaction(function() {
                    untracked(function() {
                        var t, r
                        try {
                            for (var n = __values(e.keys()), o = n.next(); !o.done; o = n.next()) {
                                var a = o.value
                                e.delete(a)
                            }
                        } catch (e) {
            ...
            (e.prototype.toPOJO = function() {
                var e,
                    ...
                    r = {}
                try {
                    for (var n = __values(this), o = n.next(); !o.done; o = n.next()) {
    ...
    ObservableSet = (function() {
        ...
        return (
            ...
            (e.prototype.clear = function() {
                ...
                transaction(function() {
                    untracked(function() {
                        ...
                        try {
                            for (
                                var n = __values(e._data.values()), o = n.next();
                                !o.done;
                                o = n.next()
                            ) {
                                var a = o.value
            ...
            (e.prototype.add = function(e) {
                var t = this
                if (
                    (checkIfStateModificationsAreAllowed(this._atom), hasInterceptors(this)) &&
                    !(o = interceptChange(this, { type: "add", object: this, newValue: e }))
                )
                    return this
                if (!this.has(e)) {
                    transaction(function() {
            ...
            (e.prototype.delete = function(e) {
                ...
                if (
                    hasInterceptors(this) &&
                    !(o = interceptChange(this, { type: "delete", object: this, oldValue: e }))
                )
                    return !1
                if (this.has(e)) {
                    var r = isSpyEnabled(),
    ...
    ObservableObjectAdministration = (function() {
        ...
        return (
            ...
            (e.prototype.write = function(e, t) {
                var r = this.target,
                    n = this.values.get(e)
                if (n instanceof ComputedValue) n.set(t)
                else {
                    if (hasInterceptors(this)) {
                        if (
                            !(i = interceptChange(this, {
                                type: "update",
                                object: this.proxy || r,
                                name: e,
                                newValue: t
                        ...
                        var o = hasListeners(this),
                            ...
                            i =
                                o || a
                                    ...
                                    : null
                        0, n.setNewValue(t), o && notifyListeners(this, i)
                    }
                }
            }),
            (e.prototype.has = function(e) {
            ...
            (e.prototype.addObservableProp = function(e, t, r) {
                ...
                var a = new ObservableValue(t, r, this.name + "." + stringifyKey(e), !1)
                this.values.set(e, a),
                    (t = a.value),
            ...
            (e.prototype.remove = function(e) {
                if (this.values.has(e)) {
                    ...
                    try {
                        ...
                        var s =
                            r || n
                                ? { type: "remove", object: this.proxy || t, oldValue: a, name: e }
                                : null
                        0, r && notifyListeners(this, s)
                    } finally {
                        endBatch()
                    }
                }
                ...
                var r = hasListeners(this),
                    ...
                    o =
                        r || n
                            ...
                            : null
                if ((r && notifyListeners(this, o), this.pendingKeys)) {
            ...
            (e.prototype.getKeys = function() {
                ...
                var r = []
                try {
                    for (var n = __values(this.values), o = n.next(); !o.done; o = n.next()) {
                        var a = __read(o.value, 2),
                            i = a[0]
                        a[1] instanceof ObservableValue && r.push(i)
                    }
                } catch (t) {
                    e = { error: t }
                } finally {
...
function asObservableObject(e, t, r) {
    ...
    return addHiddenProp(e, $mobx, n), n
}
...
function getAtom(e, t) {
    if ("object" == typeof e && null !== e) {
        ...
        if ((initializeInstance(e), t && !e[$mobx] && e[t], isObservableObject(e)))
            return t ? ((n = e[$mobx].values.get(t)) || fail(!1), n) : fail(!1)
...
function eq(e, t, r, n, o) {
    ...
    if (0 === r) return !1
    r < 0 && (r = -1), (o = o || [])
    for (var u = (n = n || []).length; u--; ) if (n[u] === e) return o[u] === t
    if ((n.push(e), o.push(t), s)) {
        if ((u = e.length) !== t.length) return !1
        for (; u--; ) if (!eq(e[u], t[u], r - 1, n, o)) return !1
    } else {
        var p = Object.keys(e),
            d = void 0
        if (((u = p.length), Object.keys(t).length !== u)) return !1
        for (; u--; ) if (!has$1(t, (d = p[u])) || !eq(e[d], t[d], r - 1, n, o)) return !1
    }
...
function makeIterable(e) {
    return (e[Symbol.iterator] = getSelf), e
}
function getSelf() {
    return this
}
