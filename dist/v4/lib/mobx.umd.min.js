!(function(e, t) {
    ...
    var I = (function() {
                ...
                (t.prototype.reportChanged = function() {
                    Be(),
                        (function(t) {
                            ...
                            for (; r--; ) {
                                var o = n[r]
                                o.dependenciesState === e.IDerivationState.UP_TO_DATE &&
                                    (o.isTracing !== te.NONE && Ue(o, t), o.onBecomeStale()),
                                    (o.dependenciesState = e.IDerivationState.STALE)
                            }
                        })(this),
                        $e()
                }),
        ...
        T = _("Atom", I)
    function C(e, t, n) {
        void 0 === t && (t = d), void 0 === n && (n = d)
        var r = new I(e)
        return ut(r, t), ct(r, n), r
    }
    function V(e, t) {
        return e === t
    }
    ...
    function $(e, t) {
        return function() {
            ...
            return ((2 === (o = arguments).length || 3 === o.length) && "string" == typeof o[1]) ||
                (4 === o.length && !0 === o[3])
                ? ((n = s), i.apply(null, arguments))
    ...
    Object.freeze(q), Object.freeze(H)
    var W = G(M),
        J = G(function(e, t, n) {
            return null == e
                ? e
    ...
    var F = {
            box: function(e, t) {
                ...
                var n = z(t)
                return new Ee(e, K(n), n.name, !0, n.equals)
            },
            shallowBox: function(e, t) {
                return arguments.length > 2 && Z("shallowBox"), Q.box(e, { name: t, deep: !1 })
            },
            array: function(e, t) {
                arguments.length > 2 && Z("array")
                var n = z(t)
                return new qt(e, K(n), n.name)
            },
            shallowArray: function(e, t) {
                return arguments.length > 2 && Z("shallowArray"), Q.array(e, { name: t, deep: !1 })
            },
            map: function(e, t) {
                arguments.length > 2 && Z("map")
                var n = z(t)
                return new Ft(e, K(n), n.name)
            },
            shallowMap: function(e, t) {
                return arguments.length > 2 && Z("shallowMap"), Q.map(e, { name: t, deep: !1 })
            },
            set: function(e, t) {
                arguments.length > 2 && Z("set")
                var n = z(t)
                return new tn(e, K(n), n.name)
            },
            object: function(e, t, n) {
                return "string" == typeof arguments[1] && Z("object"), ft({}, e, t, z(n))
            },
            shallowObject: function(e, t) {
                return (
                    "string" == typeof arguments[1] && Z("shallowObject"),
                    Q.object(e, {}, { name: t, deep: !1 })
                )
            },
            ref: X,
            shallow: J,
        ...
        Q = function(e, t, n) {
            if ("string" == typeof arguments[1]) return W.apply(null, arguments)
            if (wt(e)) return e
            var r = b(e)
                ? Q.object(e, t, n)
                : Array.isArray(e)
    ...
    var ee,
                        ...
                        (function(e) {
                            return (
                                ...
                                (un[e] = {
                                    ...
                                    enumerable: !1,
                                    get: function() {
                                        return cn(this).read(this, e)
                                    },
                                    set: function(t) {
                                        cn(this).write(this, e, t)
                                    }
                                })
                            )
                        })(t)
        ...
        re = ne({ equals: N.structural }),
        oe = function(e, t, n) {
            if ("string" == typeof t) return ne.apply(null, arguments)
    ...
    ;(oe.struct = re),
        ((ee = e.IDerivationState || (e.IDerivationState = {}))[(ee.NOT_TRACKING = -1)] =
            "NOT_TRACKING"),
    ...
    function se(t) {
        switch (t.dependenciesState) {
            ...
            case e.IDerivationState.POSSIBLY_STALE:
                for (var n = ve(!0), r = pe(), o = t.observing, i = o.length, a = 0; a < i; a++) {
                    var s = o[a]
                    if (ke(s)) {
                        if (Ve.disableErrorBoundaries) s.get()
                        else
                            try {
                                s.get()
                            } catch (e) {
    ...
    function ce(t, n, r) {
        ...
        ye(t),
            ...
            (t.runId = ++Ve.runId)
        var i,
            a = Ve.trackingDerivation
        if (((Ve.trackingDerivation = t), !0 === Ve.disableErrorBoundaries)) i = n.call(r)
        else
            try {
                i = n.call(r)
            } catch (e) {
        ...
        return (
            ...
            (function(t) {
                for (
                    ...
                    var u = r[s]
                    0 === u.diffValue && ((u.diffValue = 1), i !== s && (r[i] = u), i++),
                        u.dependenciesState > o && (o = u.dependenciesState)
                }
                ;(r.length = i), (t.newObserving = null), (a = n.length)
                for (; a--; ) {
                    var u = n[a]
                    0 === u.diffValue && Pe(u, t), (u.diffValue = 0)
                }
                for (; i--; ) {
                    var u = r[i]
                    1 === u.diffValue && ((u.diffValue = 0), Ne(u, t))
                }
                o !== e.IDerivationState.UP_TO_DATE &&
    ...
    function Oe(e, t, n) {
        ...
        if (r) {
            ...
            Fe({ type: "action", name: e, object: t, arguments: a })
        }
        var u = pe()
        Be()
        var c = {
        ...
        return (be = c.actionId), c
    }
    function Se(e) {
        be !== e.actionId && p("invalid action stack. did you forget to finish an action?"),
            (be = e.parentActionId),
            void 0 !== e.error && (Ve.suppressReactionErrors = !0),
            xe(e.prevAllowStateChanges),
            de(e.prevAllowStateReads),
            $e(),
            he(e.prevDerivation),
            e.notifySpy && Ze({ time: Date.now() - e.startTime }),
    ...
    var Ee = (function(e) {
        function t(t, n, r, o, i) {
            ...
            return (
                ...
                o && Xe() && Ye({ type: "create", name: a.name, newValue: "" + a.value }),
                a
            )
        }
        return (
            ...
            (t.prototype.set = function(e) {
                ...
                if ((e = this.prepareNewValue(e)) !== Ve.UNCHANGED) {
                    var n = Xe()
                    n && Fe({ type: "update", name: this.name, newValue: e, oldValue: t }),
                        this.setNewValue(e),
                        n && Ze()
                }
            }),
            ...
            (t.prototype.setNewValue = function(e) {
                ...
                ;(this.value = e),
                    this.reportChanged(),
                    Tt(this) && Vt(this, { type: "update", object: this, newValue: e, oldValue: t })
            }),
    ...
    Ee.prototype[A()] = Ee.prototype.valueOf
    var De = _("ObservableValue", Ee),
        je = (function() {
            function t(t) {
                ;(this.dependenciesState = e.IDerivationState.NOT_TRACKING),
                    ...
                    (this.name = t.name || "ComputedValue@" + f()),
                    t.set && (this.setter = _e(this.name + "-setter", t.set)),
                    (this.equals =
                        t.equals || (t.compareStructural || t.struct ? N.structural : N.default)),
            ...
            return (
                (t.prototype.onBecomeStale = function() {
                    !(function(t) {
                        ...
                        for (; r--; ) {
                            var o = n[r]
                            o.dependenciesState === e.IDerivationState.UP_TO_DATE &&
                                ((o.dependenciesState = e.IDerivationState.POSSIBLY_STALE),
                                o.isTracing !== te.NONE && Ue(o, t),
                                o.onBecomeStale())
                        }
                    })(this)
                }),
                ...
                (t.prototype.get = function() {
                    this.isComputing &&
                        ...
                        0 !== Ve.inBatch || 0 !== this.observers.length || this.keepAlive
                            ? (Me(this),
                              se(this) &&
                ...
                (t.prototype.trackAndCompute = function() {
                    Xe() && Ye({ object: this.scope, type: "compute", name: this.name })
                    var t = this.value,
                        n = this.dependenciesState === e.IDerivationState.NOT_TRACKING,
                        r = this.computeValue(!0),
                        o = n || ae(t) || ae(r) || !this.equals(t, r)
    ...
    je.prototype[A()] = je.prototype.valueOf
    var ke = _("ComputedValue", je),
        Re = [
            "mobxGuid",
            "spyListeners",
            "enforceActions",
        ...
        Ve = (function() {
            ...
            return (
                ...
                e.__mobxGlobals && e.__mobxGlobals.version !== new Ie().version && (Te = !1),
                Te
                    ? e.__mobxGlobals
    ...
    function Me(e) {
        ...
        return null !== t
            ? (t.runId !== e.lastAccessedBy &&
              ...
              !0)
            : (0 === e.observers.length && Ve.inBatch > 0 && Le(e), !1)
    }
    function Ue(e, t) {
        if (
            (console.log(
    ...
    var Ge = (function() {
        ...
        return (
            ...
            (t.prototype.schedule = function() {
                this._isScheduled ||
                    ((this._isScheduled = !0), Ve.pendingReactions.push(this), ze())
            }),
            ...
            (t.prototype.runReaction = function() {
                if (!this.isDisposed) {
                    if ((Be(), (this._isScheduled = !1), se(this))) {
            ...
            (t.prototype.track = function(e) {
                ...
                var t,
                    n = Xe()
                n && ((t = Date.now()), Fe({ name: this.name, type: "reaction" })),
                    (this._isRunning = !0)
                var r = ce(this, e, void 0)
                ;(this._isRunning = !1),
                    (this._isTrackPending = !1),
                    this.isDisposed && le(this),
                    ae(r) && this.reportExceptionInDerivation(r.cause),
                    n && Ze({ time: Date.now() - t }),
                    $e()
            }),
            (t.prototype.reportExceptionInDerivation = function(e) {
                ...
                if (this.errorHandler) this.errorHandler(e, this)
                    ...
                    Ve.suppressReactionErrors
                        ...
                        : console.error(n, e),
                        Xe() && Ye({ type: "error", name: this.name, message: n, error: "" + e }),
            ...
            (t.prototype.dispose = function() {
                this.isDisposed ||
                    ((this.isDisposed = !0), this._isRunning || (Be(), le(this), $e()))
            }),
    ...
    function ze() {
        Ve.inBatch > 0 || Ve.isRunningReactions || He(Ke)
    }
    function Ke() {
    ...
    function Ye(e) {
        if (Ve.spyListeners.length)
            for (var t = Ve.spyListeners, n = 0, r = t.length; n < r; n++) t[n](e)
    }
    function Fe(e) {
        Ye(r(r({}, e), { spyReportStart: !0 }))
    }
    var Qe = { spyReportEnd: !0 }
    function Ze(e) {
        Ye(e ? r(r({}, e), { spyReportEnd: !0 }) : Qe)
    }
    function et(e) {
        return (
            Ve.spyListeners.push(e),
            v(function() {
    ...
    function nt(e) {
        return function(t, n, r) {
            if (r) {
                if (r.value)
                    return { value: _e(e, r.value), enumerable: !1, configurable: !0, writable: !0 }
                var o = r.initializer
                return {
                    enumerable: !1,
                    configurable: !0,
    ...
    rt.bound = function(e, t, n, r) {
        return !0 === r
            ...
            ? {
                  ...
                  enumerable: !1,
                  get: function() {
                      return ot(this, t, n.value || n.initializer.call(this)), this[t]
                  },
                  set: tt
              }
            : {
    ...
    function lt(e, t, n, r) {
        var o = "function" == typeof r ? pn(t, n) : pn(t),
    ...
    function ft(e, t, n, r) {
        var o = (r = z(r)).defaultDecorator || (!1 === r.deep ? X : W)
        B(e), on(e, r.name, o.enhancer), Be()
        try {
            for (var i in t) {
                var a = Object.getOwnPropertyDescriptor(t, i)
                0
                var s = n && i in n ? n[i] : a.get ? ne : o
                0
                var u = s(e, i, a, !0)
    ...
    function _t(e, t) {
        ...
        return fn(e) || !!e.$mobx || T(e) || We(e) || ke(e)
    }
    function wt(e) {
        return 1 !== arguments.length && p(!1), _t(e)
    }
    function Ot(e) {
        return fn(e)
            ? e.$mobx.getKeys()
    ...
    function St(e, t) {
        ...
        return Zt(e) ? e.has(t) : nn(e) ? e.has(t) : Xt(e) ? t >= 0 && t < e.length : p(!1)
    }
    yt.prototype = Object.create(Error.prototype)
    var At = { detectCycles: !0, exportMapsAsObjects: !0, recurseEverything: !1 }
    function xt(e, t, n, r) {
    ...
    ;(Lt = Ut),
        ...
        void 0 !== Object.setPrototypeOf
            ? Object.setPrototypeOf(Lt.prototype, Bt)
            : void 0 !== Lt.prototype.__proto__
            ? (Lt.prototype.__proto__ = Bt)
            : (Lt.prototype = Bt),
    ...
    var Gt = (function() {
            function e(e, t, n, r) {
                ;(this.array = n),
                    ...
                    (this.atom = new I(e || "ObservableArray@" + f())),
            ...
            return (
                ...
                (e.prototype.updateArrayLength = function(e, t) {
                    ...
                    ;(this.lastKnownLength += t), t > 0 && e + t + 1 > Mt && Wt(e + t + 1)
                }),
                    ...
                    var o = !this.owned && Xe(),
                        ...
                        a =
                            i || o
                                ...
                                : null
                    o && Fe(r(r({}, a), { name: this.atom.name })),
        ...
        qt = (function(e) {
            function t(t, n, r, o) {
                ...
                if ((g(i, "$mobx", a), t && t.length)) {
                    var s = Ae(!0)
                    i.spliceWithArray(0, 0, t), xe(s)
                }
                return $t && Object.defineProperty(a.array, "0", Ht), i
            }
            return (
                n(t, e),
                (t.prototype.intercept = function(e) {
                ...
                (t.prototype.move = function(e, t) {
                    ...
                    if ((n.call(this, e), n.call(this, t), e !== t)) {
                        ...
                        ;(r =
                            e < t
                                ? i(o.slice(0, e), o.slice(e + 1, t + 1), [o[e]], o.slice(t + 1))
                ...
                (t.prototype.set = function(e, t) {
                    ...
                    if (e < r.length) {
                        ...
                        var o = r[e]
                        if (kt(n)) {
                            var i = It(n, { type: "update", object: this, index: e, newValue: t })
                            if (!i) return
                            t = i.newValue
                        }
                        ;(t = n.enhancer(t, o)) !== o &&
    ...
    function Kt(e) {
        Object.defineProperty(qt.prototype, "" + e, zt(e))
    }
    function Wt(e) {
        for (var t = Mt; t < e; t++) Kt(t)
        Mt = e
    }
    Wt(1e3)
    var Jt = _("ObservableArrayAdministration", Gt)
    function Xt(e) {
        return y(e) && Jt(e.$mobx)
    }
    var Yt = {},
        Ft = (function() {
            function e(e, t, n) {
                if (
                    ...
                    (this.name = n),
                    (this.$mobx = Yt),
                    (this._keys = new qt(void 0, U, this.name + ".keys()", !0)),
                    "function" != typeof Map)
                )
                    throw new Error(
            ...
            return (
                ...
                (e.prototype.has = function(e) {
                    ...
                    if (!n) {
                        var r = (n = new Ee(this._has(e), U, this.name + "." + Qt(e) + "?", !1))
                ...
                (e.prototype.delete = function(e) {
                    var t = this
                    if (kt(this) && !(i = It(this, { type: "delete", object: this, name: e })))
                        return !1
                    if (this._has(e)) {
                        var n = Xe(),
                            o = Tt(this),
                            i =
                                o || n
                                    ...
                                    : null
                        return (
                            n && Fe(r(r({}, i), { name: this.name, key: e })),
                            Dt(function() {
                                t._keys.remove(e),
                        ...
                        var o = Xe(),
                            ...
                            a =
                                i || o
                                    ...
                                    : null
                        o && Fe(r(r({}, a), { name: this.name, key: e })),
                            n.setNewValue(t),
                            i && Vt(this, a),
                            o && Ze()
                    }
                ...
                (e.prototype._addValue = function(e, t) {
                    var n = this
                    Dt(function() {
                        var r = new Ee(t, n.enhancer, n.name + "." + Qt(e), !1)
                        n._data.set(e, r),
                            (t = r.value),
                    ...
                    var o = Xe(),
                        i = Tt(this),
                        a = i || o ? { type: "add", object: this, name: e, newValue: t } : null
                    o && Fe(r(r({}, a), { name: this.name, key: e })), i && Vt(this, a), o && Ze()
                }),
                                ...
                                var n,
                                    r =
                                        w((n = e)) || Zt(n)
                                            ...
                                            : p("Cannot convert to map from '" + n + "'"),
                                    o = t._keys,
                                    i = Array.from(r.keys()),
                                    a = !1,
                                    s = 0;
                ...
                (e.prototype.toPOJO = function() {
                    ...
                    return (
                        this._keys.forEach(function(n) {
                            return (t["symbol" == typeof n ? n : Qt(n)] = e.get(n))
                        }),
                        t
                    )
                }),
    ...
    D(Ft.prototype, function() {
        return this.entries()
    }),
        g(Ft.prototype, k(), "Map")
    var Zt = _("ObservableMap", Ft),
        en = {},
        tn = (function() {
            function e(e, t, n) {
                if (
            ...
            return (
                ...
                (e.prototype.add = function(e) {
                    var t = this
                    if (
                        (ue(this._atom), kt(this)) &&
                        !(o = It(this, { type: "add", object: this, newValue: e }))
                    )
                        return this
                    if (!this.has(e)) {
                        Dt(function() {
                ...
                (e.prototype.delete = function(e) {
                    var t = this
                    if (kt(this) && !(o = It(this, { type: "delete", object: this, oldValue: e })))
                        return !1
                    if (this.has(e)) {
                        var n = Xe(),
                            r = Tt(this),
    ...
    D(tn.prototype, function() {
        return this.values()
    }),
        g(tn.prototype, k(), "Set")
    var nn = _("ObservableSet", tn),
        rn = (function() {
            function e(e, t, n) {
            ...
            return (
                ...
                (e.prototype.write = function(e, t, n) {
                    ...
                    var i = this.values[t]
                    if (i instanceof je) i.set(n)
                    else {
                        if (kt(this)) {
                            if (
                                !(u = It(this, { type: "update", object: o, name: t, newValue: n }))
                            )
                                return
                            n = u.newValue
                        }
                            ...
                            var a = Tt(this),
                                ...
                                u =
                                    a || s
                                        ...
                                        : null
                            s && Fe(r(r({}, u), { name: this.name, key: t })),
                                i.setNewValue(n),
                                a && Vt(this, u),
                                s && Ze()
                        }
                ...
                (e.prototype.remove = function(e) {
                    if (this.values[e]) {
                        var t = this.target
                        if (kt(this))
                            if (!(a = It(this, { object: t, name: e, type: "remove" }))) return
                        try {
                            Be()
                            var n = Tt(this),
                                o = Xe(),
                            ...
                            var a =
                                n || o ? { type: "remove", object: t, oldValue: i, name: e } : null
                            o && Fe(r(r({}, a), { name: this.name, key: e })),
                                n && Vt(this, a),
                                o && Ze()
                        } finally {
    ...
    function on(e, t, n) {
        void 0 === t && (t = ""), void 0 === n && (n = M)
        var r = e.$mobx
        return (
            r ||
            (b(e) || (t = (e.constructor.name || "ObservableObject") + "@" + f()),
            t || (t = "ObservableObject@" + f()),
            g(e, "$mobx", (r = new rn(e, t, n))),
            r)
        )
    }
    function an(e, t, n, o) {
        var i = on(e)
        if (kt(i)) {
            var a = It(i, { object: e, name: t, type: "add", newValue: n })
            if (!a) return
            n = a.newValue
        }
        ;(n = (i.values[t] = new Ee(n, o, i.name + "." + t, !1)).value),
            Object.defineProperty(
                e,
                t,
                (function(e) {
            ...
            (function(e, t, n, o) {
                var i = Tt(e),
                    a = Xe(),
                    s = i || a ? { type: "add", object: t, name: n, newValue: o } : null
                a && Fe(r(r({}, s), { name: e.name, key: n }))
                i && Vt(e, s)
                a && Ze()
            })(i, e, t, n)
    }
    ...
    var ln = _("ObservableObjectAdministration", rn)
    function fn(e) {
        return !!y(e) && (B(e), ln(e.$mobx))
    }
    function pn(e, t) {
        if ("object" == typeof e && null !== e) {
            if (Xt(e)) return void 0 !== t && p(!1), e.$mobx.atom
            ...
            var r
            if ((B(e), t && !e.$mobx && e[t], fn(e)))
                return t ? ((r = e.$mobx.values[t]) || p(!1), r) : p(!1)
            if (T(e) || ke(e) || We(e)) return e
        } else if ("function" == typeof e && We(e.$mobx)) return e.$mobx
        return p(!1)
    }
    function hn(e, t) {
        return (
            ...
            void 0 !== t
                ...
                : Zt(e) || nn(e)
                ? e
                : (B(e), e.$mobx ? e.$mobx : void p(!1))
        )
    }
    function vn(e, t) {
        return (void 0 !== t ? pn(e, t) : fn(e) || Zt(e) || nn(e) ? hn(e) : pn(e)).name
    }
        ...
        return (
            ...
            (function e(t, n, r, o, i) {
                ...
                if (u) {
                    ...
                    for (; f--; )
                        if (((h = p[f]), !mn(n, h) || !e(t[h], n[h], r - 1, o, i))) return !1
                }
                o.pop()
                i.pop()
                return !0
    ...
    "object" == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ &&
        ...
        (e._allowStateReadsEnd = de),
        (e._allowStateReadsStart = ve),
        (e._endAction = Se),
        (e._getAdministration = hn),
        (e._getGlobalState = function() {
            return Ve
        }),
        (e._interceptReads = function(e, t, n) {
            var r
            if (Zt(e) || Xt(e) || De(e)) r = hn(e)
            else {
                if (!fn(e)) return p(!1)
        ...
        (e._resetGlobalState = function() {
            var e = new Ie()
            for (var t in e) -1 === Re.indexOf(t) && (Ve[t] = e[t])
        ...
        (e.configure = function(e) {
            ...
            if (
                ...
                ;(Ve.enforceActions = c), (Ve.allowStateChanges = !0 !== c && "strict" !== c)
            }
            void 0 !== n && (Ve.computedRequiresReaction = !!n),
                void 0 !== s && (Ve.reactionRequiresObservable = !!s),
                void 0 !== u &&
        ...
        (e.extendObservable = ft),
        (e.extendShallowObservable = function(e, t, n) {
            return ft(e, t, n, H)
        }),
        (e.flow = function(e) {
            1 !== arguments.length &&
                p("Flow expects one 1 argument and cannot be used as decorator")
            var t = e.name || "<unnamed flow>"
            return function() {
                var n,
                    r = arguments,
                    o = ++dt,
                    i = rt(t + " - runid: " + o + " - init", e).apply(this, r),
                    a = void 0,
                    s = new Promise(function(e, r) {
                        ...
                        function u(e) {
                            ...
                            a = void 0
                            try {
                                n = rt(t + " - runid: " + o + " - yield " + s++, i.next).call(i, e)
                            } catch (e) {
                                return r(e)
                            }
                            l(n)
                        ...
                        function c(e) {
                            ...
                            a = void 0
                            try {
                                n = rt(t + " - runid: " + o + " - yield " + s++, i.throw).call(i, e)
                            } catch (e) {
                                return r(e)
                            }
                            l(n)
                ...
                return (
                    (s.cancel = rt(t + " - runid: " + o + " - cancel", function() {
                        try {
                            a && bt(a)
                            var e = i.return(void 0),
                                t = Promise.resolve(e.value)
                            t.then(d, d), bt(t), n(new yt())
                        } catch (e) {
                            n(e)
                        }
                    })),
        ...
        (e.get = function(e, t) {
            if (St(e, t)) return fn(e) ? e[t] : Zt(e) ? e.get(t) : Xt(e) ? e[t] : p(!1)
        }),
        (e.getAtom = pn),
        (e.getDebugName = vn),
        (e.getDependencyTree = pt),
        ...
        (e.isObservable = wt),
        (e.isObservableArray = Xt),
        (e.isObservableMap = Zt),
        (e.isObservableObject = fn),
        (e.isObservableProp = function(e, t) {
            return "string" != typeof t ? p(!1) : _t(e, t)
        }),
        (e.isObservableSet = nn),
        (e.keys = Ot),
        (e.observable = Q),
        ...
        (e.onBecomeObserved = ut),
        (e.onBecomeUnobserved = ct),
        (e.onReactionError = function(e) {
            return (
                Ve.globalReactionErrorHandlers.push(e),
                function() {
        ...
        (e.reaction = function(e, t, n) {
            void 0 === n && (n = u), "boolean" == typeof n && (n = { fireImmediately: n })
            var r,
                o,
                i,
                a = n.name || "Reaction@" + f(),
                ...
                p = !0,
                h = !1,
                v = n.compareStructural ? N.structural : n.equals || N.default,
                d = new Ge(
                    a,
                    function() {
                        p || c ? y() : h || ((h = !0), l(y))
        ...
        (e.set = function e(t, n, r) {
            if (2 !== arguments.length || nn(t))
                if (fn(t)) {
                    var o = t.$mobx
                    o.values[n] ? o.write(t, n, r) : an(t, n, r, o.defaultEnhancer)
                } else if (Zt(t)) t.set(n, r)
        ...
        (e.toJS = function(e, t) {
            ...
            return (
                ...
                (function e(t, n, r) {
                    ...
                    if (De(t)) return e(t.get(), n, r)
                    if ((wt(t) && Ot(t), !0 === n.detectCycles && null !== t && r.has(t)))
                        return r.get(t)
                    ...
                    if (nn(t) || Object.getPrototypeOf(t) === Set.prototype) {
                        if (!1 === n.exportMapsAsObjects) {
                            var u = xt(r, t, new Set(), n)
                            return (
                    ...
                    if (Zt(t) || Object.getPrototypeOf(t) === Map.prototype) {
                        if (!1 === n.exportMapsAsObjects) {
                            var l = xt(r, t, new Map(), n)
                            return (
