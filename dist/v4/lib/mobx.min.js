...
function makeIterable(e) {
    return (e[iteratorSymbol()] = getSelf), e
}
...
var defaultCreateObservableOptions = { deep: !0, name: void 0, defaultDecorator: void 0 },
    shallowCreateObservableOptions = { deep: !1, name: void 0, defaultDecorator: void 0 }
...
var observableFactories = {
        ...
        shallowObject: function(e, t) {
            return (
                "string" == typeof arguments[1] && incorrectlyUsedAsDecorator("shallowObject"),
...
function _startAction(e, t, r) {
    var n = isSpyEnabled() && !!e,
        o = 0
    if (n) {
        o = Date.now()
        var a = (r && r.length) || 0,
            i = new Array(a)
        if (a > 0) for (var s = 0; s < a; s++) i[s] = r[s]
        spyReportStart({ type: "action", name: e, object: t, arguments: i })
    }
    ...
    return (currentActionId = l.actionId), l
}
    ...
    return (
        ...
        (t.prototype.set = function(e) {
            ...
            if ((e = this.prepareNewValue(e)) !== globalState.UNCHANGED) {
                var r = isSpyEnabled()
                r && spyReportStart({ type: "update", name: this.name, newValue: e, oldValue: t }),
                    this.setNewValue(e),
                    r && spyReportEnd()
            }
        }),
        ...
        return (
            ...
            (e.prototype.get = function() {
                this.isComputing &&
                    ...
                    0 !== globalState.inBatch || 0 !== this.observers.length || this.keepAlive
                        ? (reportObserved(this),
                          shouldCompute(this) &&
...
function reportObserved(e) {
    ...
    return null !== t
        ? (t.runId !== e.lastAccessedBy &&
          ...
          !0)
        : (0 === e.observers.length && globalState.inBatch > 0 && queueForUnobservation(e), !1)
}
    ...
    if (e.lowestObserverState !== exports.IDerivationState.STALE) {
        ...
        for (var t = e.observers, r = t.length; r--; ) {
            ...
            n.dependenciesState === exports.IDerivationState.UP_TO_DATE &&
                (n.isTracing !== TraceMode.NONE && logTraceInfo(n, e), n.onBecomeStale()),
...
var Reaction = (function() {
    ...
    return (
        ...
        (e.prototype.track = function(e) {
            ...
            var t,
                r = isSpyEnabled()
            r && ((t = Date.now()), spyReportStart({ name: this.name, type: "reaction" })),
                (this._isRunning = !0)
        ...
        (e.prototype.reportExceptionInDerivation = function(e) {
            ...
            if (this.errorHandler) this.errorHandler(e, this)
                ...
                globalState.suppressReactionErrors
                    ...
                    : console.error(r, e),
                    isSpyEnabled() &&
                        spyReport({ type: "error", name: this.name, message: r, error: "" + e }),
...
function spyReport(e) {
    if (globalState.spyListeners.length)
        for (var t = globalState.spyListeners, r = 0, n = t.length; r < n; r++) t[r](e)
}
function spyReportStart(e) {
    spyReport(__assign(__assign({}, e), { spyReportStart: !0 }))
}
var END_EVENT = { spyReportEnd: !0 }
function spyReportEnd(e) {
    spyReport(e ? __assign(__assign({}, e), { spyReportEnd: !0 }) : END_EVENT)
}
function spy(e) {
    return (
...
function reaction(e, t, r) {
    void 0 === r && (r = EMPTY_OBJECT), "boolean" == typeof r && (r = { fireImmediately: r })
    var n,
...
function configure(e) {
    ...
    void 0 !== r && (globalState.computedRequiresReaction = !!r),
        ...
        void 0 !== c &&
            ((globalState.observableRequiresReaction = !!c),
...
function extendShallowObservable(e, t, r) {
    return extendObservable(e, t, r, shallowCreateObservableOptions)
}
...
var ObservableArrayAdministration = (function() {
                ...
                var n = !this.owned && isSpyEnabled(),
                    ...
                    a =
                        o || n
                            ...
                            : null
                n && spyReportStart(__assign(__assign({}, a), { name: this.atom.name })),
    ...
    ObservableArray = (function(e) {
        function t(t, r, n, o) {
            ...
            return (
                safariPrototypeSetterInheritanceBug && Object.defineProperty(i.array, "0", ENTRY_0),
                a
            )
        }
        return (
            ...
            (t.prototype.move = function(e, t) {
                ...
                if ((r.call(this, e), r.call(this, t), e !== t)) {
                    ...
                    ;(n =
                        e < t
                            ? __spread(o.slice(0, e), o.slice(e + 1, t + 1), [o[e]], o.slice(t + 1))
...
function reserveArrayBuffer(e) {
    for (var t = OBSERVABLE_ARRAY_BUFFER_SIZE; t < e; t++) createArrayBufferItem(t)
    ...
    ObservableMap = (function() {
        ...
        return (
                    ...
                    var r = isSpyEnabled(),
                        ...
                        o =
                            n || r
                                ...
                                : null
                    return (
                        r && spyReportStart(__assign(__assign({}, o), { name: this.name, key: e })),
                    ...
                    var n = isSpyEnabled(),
                        ...
                        a =
                            o || n
                                ...
                                : null
                    n && spyReportStart(__assign(__assign({}, a), { name: this.name, key: e })),
                        r.setNewValue(t),
                        o && notifyListeners(this, a),
                        n && spyReportEnd()
                }
            ...
            (e.prototype._addValue = function(e, t) {
                ...
                var n = isSpyEnabled(),
                    o = hasListeners(this),
                    a = o || n ? { type: "add", object: this, name: e, newValue: t } : null
                n && spyReportStart(__assign(__assign({}, a), { name: this.name, key: e })),
                    o && notifyListeners(this, a),
                    n && spyReportEnd()
            }),
        ...
        return (
                        ...
                        var a = hasListeners(this),
                            ...
                            s =
                                a || i
                                    ...
                                    : null
                        i && spyReportStart(__assign(__assign({}, s), { name: this.name, key: t })),
                            o.setNewValue(r),
            ...
            (e.prototype.remove = function(e) {
                if (this.values[e]) {
                    var t = this.target
                    if (hasInterceptors(this))
                        if (!(a = interceptChange(this, { object: t, name: e, type: "remove" })))
                            return
                    try {
                        startBatch()
                        ...
                        var a = r || n ? { type: "remove", object: t, oldValue: o, name: e } : null
                        n && spyReportStart(__assign(__assign({}, a), { name: this.name, key: e })),
...
function asObservableObject(e, t, r) {
    ...
    return (
        ...
        addHiddenFinalProp(e, "$mobx", (n = new ObservableObjectAdministration(e, t, r))),
        n)
    )
}
function defineObservableProperty(e, t, r, n) {
    ...
    if (hasInterceptors(o)) {
        var a = interceptChange(o, { object: e, name: t, type: "add", newValue: r })
        if (!a) return
        r = a.newValue
    }
...
function notifyPropertyAddition(e, t, r, n) {
    ...
    a && spyReportStart(__assign(__assign({}, i), { name: e.name, key: r })),
...
function eq(e, t, r, n, o) {
    ...
    if ((n.push(e), o.push(t), s)) {
        ...
        for (; u--; ) if (!has$1(t, (b = p[u])) || !eq(e[b], t[b], r - 1, n, o)) return !1
    }
